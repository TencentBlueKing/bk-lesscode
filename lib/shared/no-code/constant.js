...
export const REGX_CHIOCE_LIST = () => ([
    ...
    { id: 'FLOAT', name: sharedI18n().t('浮点数'), type: ['STRING', 'INPUT'] },
    { id: 'NON_NEGATIVE', name: sharedI18n().t('非负数（0，正数，正浮点数）'), type: ['STRING', 'INPUT'] },
    { id: 'NON_POSITIVE', name: sharedI18n().t('非正数（0，负数，负浮点数）'), type: ['STRING', 'INPUT'] },
    { id: 'GTE_ZERO', name: sharedI18n().t('大于零的数（包括正数和正浮点数）'), type: ['STRING', 'INPUT'] },
    { id: 'LTE_ZERO', name: sharedI18n().t('小于零的数（包括负数和负浮点数）'), type: ['STRING', 'INPUT'] },
    { id: 'LOWER_EN', name: sharedI18n().t('仅小写字母'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'UPPER_EN', name: sharedI18n().t('仅大写字母'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'EN', name: sharedI18n().t('仅英文字符'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'EN_NUM', name: sharedI18n().t('仅能包含英文字符和数字'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'CH', name: sharedI18n().t('仅中文字符'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'EN_CH', name: sharedI18n().t('仅能包含中英文字符'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'EN_CH_NUM', name: sharedI18n().t('仅能包含中英文，数字，下划线'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'START_EN', name: sharedI18n().t('包含中英文，数字，以英文字符开头'), type: ['STRING', 'INPUT', 'TEXT', 'TEXTAREA'] },
    { id: 'EMAIL', name: sharedI18n().t('邮箱'), type: ['STRING', 'INPUT'] },
    { id: 'PHONE_NUM', name: sharedI18n().t('内地手机号码'), type: ['STRING', 'INPUT'] },
    { id: 'ID_CARD', name: sharedI18n().t('身份证'), type: ['STRING', 'INPUT'] },
    { id: 'IP', name: sharedI18n().t('IP地址'), type: ['STRING', 'INPUT'] },
    { id: 'QQ', name: sharedI18n().t('腾讯QQ号'), type: ['STRING', 'INPUT'] },
