...
export default function (layoutType, layoutContent) {
    ...
    .bk-lesscode-navigation-wrapper .navigation-container .container-content {
        padding: 0px !important;
     }
    .navigation-header {
        -webkit-box-flex:1;
    ...
    .navigation-header .header-right-area {
        display: flex;
        align-items: center
    }
    .header-right-area .custom-area {
        margin-right: 10px;
        max-height: 52px;
        overflow: hidden;
    }

    .header-right-area .info-language {
        cursor: pointer;
        margin-right: 16px;
    }
    .header-right-area .info-language i {
        font-size: 18px;
        color: #979aa5;
    }
    .popover-link {
    ...
    .navigation-header .is-complex-item.is-complex-active {
