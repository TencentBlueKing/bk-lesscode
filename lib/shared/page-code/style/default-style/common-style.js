...
/**
 * @desc 返回需要内置固有的样式
 * @param { Boolean } isStaticCommonStyle 是否插入固定样式
 * @param { String } pageType 页面类型
 * @returns { String }
 */
export function getStaticCommonStyle (isStaticCommonStyle, pageType) {
    if (pageType === 'projectCode') {
        return '@import \'@/css/common.css\';'
    }
    if (!isStaticCommonStyle) return ''
