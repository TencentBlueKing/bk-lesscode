                ...
                <template v-slot:header>
                    <div class="navigation-header">
                        ...
                        <div class="header-right-area">
                            ...
                            ${generateHelpMenu(code, isWhiteTheme, '#content', 'empty-padding')}
                ...
                <template #header>
                    <div class="navigation-header">
                        ...
                        <div class="header-right-area">
                            ...
                            ${generateHelpMenu(code, true, '#content', 'empty-padding')}
                ...
                <template #header>
                    <div class="navigation-header">
                        ...
                        <div class="header-right-area">
                            ...
                            ${generateHelpMenu(code, isWhiteTopTheme, '#content', 'empty-padding')}
                            <bk-popover class="nav-head-right" theme="light navigation-message empty-padding" :arrow="false" offset="-10, 0" placement="bottom-start" :tippy-options="{ 'hideOnClick': false, appendTo: 'parent' }">
