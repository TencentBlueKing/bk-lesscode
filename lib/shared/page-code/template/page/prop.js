...
import { getMethodByCode, sharedI18n } from '../../common/utils'
    ...
    for (const i in props) {
        ...
        if (i !== 'slots' && i !== 'class') {
            ...
            // 自定义变量代替默认变量名称
                ...
                code.handleUsedVariable('variable', val, `${sharedI18n().t('组件')}【${compId}】${sharedI18n().t('的')}【${i}】${sharedI18n().t('属性')}`)
            }
            ...
            if (format !== 'value') {
                code.handleUsedVariable(format, val, `${sharedI18n().t('组件')}【${compId}】${sharedI18n().t('的')}【${i}】${sharedI18n().t('属性')}`)
                propsStr += curPropStr
                continue
            // 处理封装的table组件的分页
                        ...
                        .reduce((acc, cur) => {
                            ...
                            if (cur === 'count') {
                                ...
                                if (item.buildInVariableType === 'CUSTOM') {
                                    code.handleUsedVariable('variable', item.customVariableCode, `${sharedI18n().t('组件')}【${compId}】${sharedI18n().t('的')}【${i}】${sharedI18n().t('属性')}`)
                                ...
                                code.handleUsedVariable(item.format, item.code, `${sharedI18n().t('组件')}【${compId}】${sharedI18n().t('的')}【${i}】${sharedI18n().t('属性')}`)
