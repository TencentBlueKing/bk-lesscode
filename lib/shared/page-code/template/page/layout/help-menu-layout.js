export default function generateHelpMenu (code, isWhiteTheme, slotName, themeType) {
    ...
    return `<bk-popover v-if="${helpMenuKey}.length > 0"  class="nav-help-menu" theme="light navigation-message ${themeType}"  placement="bottom-end" :arrow="false" :distance="5" :tippy-options="{ hideOnClick: false, appendTo: 'parent' }">
