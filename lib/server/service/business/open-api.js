        ...
        apiName,
        {
            ...
            proxy_http: {
                ...
                upstreams: {
                    ...
                    hosts: [
                        {
                            host: JSON.parse(process.env.BKPAAS_DEFAULT_PREALLOCATED_URLS)[process.env.BKPAAS_ENVIRONMENT],
                            weight: '100'
                        }
                    ]
                }
...
export const grantApiPermissionForItsm = async () => {
    ...
    await grantPermissions(
        apiName,
        {
            ...
            resource_names: ['dataManage', 'filterTableDataByKeys', 'filterTableDataByConditions']
        },
        token,
        'prod'
    )
