...
const { fetchResource, check, myProject, checkNoResources, fetchAuthSubject, fetchIamAppPermModel, updateIamAppPermModel } = require('../controller/iam')

const router = new Router({
    prefix: '/api/iam'
})

router.use(['/auth-subject', '/app-perm-model'], async (ctx, next) => {
...
router.get('/app-perm-model', fetchIamAppPermModel)
router.put('/app-perm-model', updateIamAppPermModel)
