...
export const checkNpmSetting = (throwErr = true) => {
...
export const npmPublish = async (params) => {
    try {
        ...
        // 去除路径名中的./\符号
        const componentDirName = params.componentDirName?.replace(/[./\\]/g, '_')
        // 创建组件文件夹
        const componentPath = path.resolve(npmTempDir, componentDirName)
