...
export const getNodeComponentConfig = (projectId, node) => {
    ...
    if (pluginName === 'pause_node') {
        ...
        const apiURL = `${httpConf.apiGateWayUrlTmpl.replace('{api_name}', global.LESSCODE_API_GATEWAY_NAME)}/${process.env.BKPAAS_ENVIRONMENT}/dataManage`
        componentConfig.data = {
