...
const iamConf = require('./conf/iam')
...
const { generateApiGateway, grantApiPermissionForItsm } = require('./service/business/open-api')
...
async function startServer () {
    ...
    // 默认给itsm授权
    await grantApiPermissionForItsm()
