...
const { registerNoticeCenter } = require('./service/business/notice-center')
const { createBkFlowSpace } = require('./service/business/flow')
...
async function startServer () {
    try {
        ...
        // 注册消息通知中心
        await registerNoticeCenter()
        // 为lesscode平台创建bkflow空间
        await createBkFlowSpace()
    } catch (error) {
        console.log(error, '注册网关相关错误')
    }
