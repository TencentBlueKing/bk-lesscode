...
// const { executePermMigration } = require('./controller/perms-migration-helper')
...
async function startServer () {
    ...
    app.use(authMiddleware().unless({ path: [/^\/api\/open\//, /^\/api\/project\/project_list/] }))
