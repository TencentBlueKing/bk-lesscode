...
module.exports = {
    ...
    async savePageRoute (ctx) {
        try {
            const { projectId, versionId, pageRoute, platform } = ctx.request.body
    ...
    async bindPageRoute (ctx) {
        try {
            const { routeId, pageId, redirect, remove, createRoot, layoutId, layoutPath, versionId, projectId } = ctx.request.body
