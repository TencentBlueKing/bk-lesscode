    ...
    async fetchResource (ctx) {
        ...
        try {
            ...
            if (method === 'fetch_instance_info') {
                ...
                const query = { deleteFlag: 0, isOffcial: 0, id: [] }
                ids.forEach(id => {
                    query.id.push(id)
                })
                ...
                if (method === 'list_instance') {
                    res = await LCDataService.get({
                        ...
                        page: pageData.page,
                        pageSize: pageData.page_size,
                        query: { deleteFlag: 0, isOffcial: 0 }
                    })
                    ...
                    res = await LCDataService.get({
                        ...
                        page: pageData.page,
                        pageSize: pageData.page_size,
                        query: [{ deleteFlag: 0, isOffcial: 0, projectCode: `%${query}%` }, { deleteFlag: 0, isOffcial: 0, id: `%${query}%` }]
                    })
                }
