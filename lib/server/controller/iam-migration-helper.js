...
async function initAction () {
    ...
    return sendReq(
        ...
        [
            ...
            {
                id: 'download_app_template_source',
                name: '应用公开模板源码下载',
            ...
            {
                id: 'download_page_template_source',
                name: '页面公开模板源码下载',
