...
async function initSystem () {
    return sendReq(
        ...
        {
            id: IAM_APP_ID,
            name: 'hieicomponents 测试',
            name_en: 'hieicomponents-name',
            description: 'hieicomponents demo',
            description_en: 'hieicomponents demo',
            clients: 'hieicomponents',
            provider_config: {
    ...
    return sendReq(
        ...
        [
            ...
            },
            {
                ...
                name: IAM_ACTION.create_app[1],
                name_en: 'Create App',
                description: IAM_ACTION.create_app[2],
            ...
            },
            {
                ...
                name: IAM_ACTION.create_app_with_template[1],
                name_en: 'Create App With Template',
                description: IAM_ACTION.create_app_with_template[2],
            ...
            },
            {
                ...
                name: IAM_ACTION.preview_app_template[1],
                name_en: 'Preview App Template',
                description: IAM_ACTION.preview_app_template[2],
            ...
            },
            {
                ...
                name: IAM_ACTION.download_app_template_source[1],
                name_en: 'Download App Template Source',
                description: IAM_ACTION.download_app_template_source[2],
            ...
            },
            {
                ...
                name: IAM_ACTION.create_page_with_template[1],
                name_en: 'Create Page With Template',
                description: IAM_ACTION.create_page_with_template[2],
            ...
            },
            {
                ...
                name: IAM_ACTION.preview_page_template[1],
                name_en: 'Preview Page Template',
                description: IAM_ACTION.preview_page_template[2],
            ...
            },
            {
                ...
                name: IAM_ACTION.download_page_template_source[1],
                name_en: 'Download Page Template Source',
                description: IAM_ACTION.download_page_template_source[2],
...
async function iamTrans () {
    try {
        ...
        // 先找出 username 为 hieiwang 的测试，找自己名字的数据，便于直接去权限中心删除测试数据
        const testData = userRoleProjectData.filter(item => item.username === 'hieiwang')
        console.error(testData.length, IAM_APP_ID)
        ...
        const manageAppFailedList = await handleGrantApp(
            testData.filter(item => String(item.roleId) === '1'),
            [
        ...
        if (manageAppFailedList.length) {
            const msg = `管理权限迁移失败: ${JSON.stringify(manageAppFailedList)}`
            logger.info(msg)
            return {
                code: -1,
                message: msg
        ...
        if (devAppFailedList.length) {
            const msg = `开发部署权限迁移失败: ${JSON.stringify(devAppFailedList)}`
            logger.info(msg)
            return {
                code: -1,
                message: msg
