...
module.exports = {
    ...
    async queryProject (ctx) {
        ...
        logger.info(`before projectList.length: ${projectList.length}`)
        ...
        logger.info(`after projectList.length: ${projectList.length}`)
        logger.info(`projectList: ${JSON.parse(projectList)}`)
