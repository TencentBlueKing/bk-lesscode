...
import { createNocodeForm, updateNocodeForm, getFormDetail, getFormList } from '../service/nocode-form'
import {
    Controller,
    Get,
    Post,
...
export default class NocodeFormController {
    ...
    async formList (
        ...
        return list || []
        // leftJoin
        // const { list } = await LCDataService.leftJoinQuery(
        //     TABLE_FILE_NAME.FORM,
        //     [{ tableName: TABLE_FILE_NAME.DATA_TABLE, on: `${TABLE_FILE_NAME.DATA_TABLE}.id = ${TABLE_FILE_NAME.FORM}.dataSourceId` }],
        //     {
        //         express: `${TABLE_FILE_NAME.FORM}.projectId = :projectId AND ${TABLE_FILE_NAME.FORM}.versionId = :versionId AND deleteFlag = 0`,
        //         data: { projectId, versionId: versionId || null }
        //     },
