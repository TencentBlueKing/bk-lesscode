...
export default class DataSourceController {
    ...
    async getTables (
        ...
        const getTableMap = {
            ...
            'third-part': () => getTablesInPreview(projectId, page, pageSize, thirdPartDBId)
        }
    ...
    // 新增表结构
    @OutputJson()
    @ProjectAuthorization({ getId: ctx => ctx.request.body.dataTable.projectId, needAuthActions: [IAM_ACTION.develop_app[0]] })
    @Post('/addTable')
    async addTable (
    ...
    async getOnlineTableList (
        ...
        return onlineDBService.describeTables(onlineTables, previewDbConfig.database)
    }
    ...
    async queryBySqlWithTime (
        ...
        const querySqlMap = {
            ...
            'third-part': () => execSqlInPreview(projectId, sql, thirdPartDBName)
        }
