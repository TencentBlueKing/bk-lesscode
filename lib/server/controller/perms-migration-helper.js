...
const APP_ID = 'hiei-test'
const APP_SECRET = 'TMhghDazn9xmCVj4aJJB8ftlzx89W9ZmZ1KD5NG15tU7ZjpJ8K'
...
async function updateSystem () {
    ...
    try {
        await getConnection().transaction(async transactionalEntityManager => {
            ...
            const url = `http://bk-iam.apigw.o.oa.com/dev/api/v1/model/systems/${APP_ID}`
            const data = {
                'id': 'hiei-test',
                'name': 'lesscode 测试',
...
async function initResourceType () {
    try {
        const url = `http://bk-iam.apigw.o.oa.com/dev/api/v1/model/systems/${APP_ID}/resource-types`
        const data = [
            {
                'id': 'app',
                'name': '应用',
...
async function updateResourceType () {
    try {
        const url = `http://bk-iam.apigw.o.oa.com/dev/api/v1/model/systems/${APP_ID}/resource-types/app`
        const data = [
            {
                'id': 'app',
                'name': '应用',
...
async function initInstanceSelection () {
    try {
        const url = `http://bk-iam.apigw.o.oa.com/dev/api/v1/model/systems/${APP_ID}/instance-selections`
        const data = [
            {
                'id': 'app_list',
                'name': '应用视图',
...
async function initAction () {
    try {
        const url = `http://bk-iam.apigw.o.oa.com/dev/api/v1/model/systems/${APP_ID}/actions`
        const data = [
            // {
