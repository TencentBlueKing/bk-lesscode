...
import { IAM_APP_PERM_RESOURCE_TYPE_ID, IAM_APP_PERM_INSTANCE_SELECTION_ID, IAM_ACTION_TYPE } from '../../shared/constant.js'
    ...
    try {
        await getConnection().transaction(async transactionalEntityManager => {
            ...
            const iamAppPermList = projectList.map(project => {
                ...
                const systemId = `bk_lesscode_${id}_${projectCode}`.substr(0, 32)
                return {
                    projectId: id,
                    systemId: systemId,
                    ...
                    provider_config: {
                        path: '/api/iam/resource-app-perm'
                    },
