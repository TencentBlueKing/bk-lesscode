...
export default class FunctionController {
    ...
    async generateToken (
        ...
        const url = `${v3Config.URL_PREFIX}/bkapps/applications/${appCode}/oauth/token/lesscode/?bk_app_code=${v3Config.APP_ID}&bk_app_secret=${encodeURI(v3Config.APP_SECRET)}&bk_token=${bkTikcet}`
