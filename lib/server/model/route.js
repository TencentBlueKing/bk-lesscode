...
export default {
    ...
    findProjectRoute (projectId, versionId) {
        return getRepository(Route)
            ...
            .leftJoinAndSelect(Form, 'form', 'page.formId = form.id')
            .leftJoinAndSelect(Flow, 'flow', 'page.flowId = flow.id')
            ...
            .select([
                ...
                'flow.formIds as flowFormIds',
                'flow.itsmId as flowServiceId',
                'dataTable.tableName as tableName',
                'page.pageType as pagePlatform',
                'pr.pageId as pageId',
