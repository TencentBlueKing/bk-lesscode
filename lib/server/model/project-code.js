...
const projectCode = {
    ...
    async generateCode (projectId, versionId, pathName) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                await this.generateDataSource(dataTables, dataTableModifyRecords, targetPath, isGenerateApigw, staticUrl)
    ...
    writeViewCode ({ currentFilePath, pathName, pageCode, targetData, funcGroups, lifeCycle, projectId, pageId, deletePageCodes, layoutContent, isGenerateNav, layoutType, variableData, styleSetting, apiList, nocodeType = '', nocodePayload, framework }) {
        return new Promise(async (resolve, reject) => {
