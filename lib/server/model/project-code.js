...
const projectCode = {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                for (const layout of layoutIns) {
                    ...
                    await this.writeViewCode(currentFilePath, { targetData: [] }, '', pathName, projectId, {}, '', layout.content, true, layout.layoutType, [], {}, apiList)
    ...
    writeViewCode (currentFilePath, pageData, pageCode, pathName, projectId, lifeCycle, pageId, layoutContent, isGenerateNav, layoutType, variableData, styleSetting, apiList) {
        return new Promise(async (resolve, reject) => {
