...
class PageCode {
    ...
    generataNocodePage () {
        ...
        const { config = {}, fields = [], formIds = {}, serviceId = 0, tableName = '', formId = 0 } = this.nocodePayload
        ...
        switch (this.nocodeType) {
            ...
            case 'FLOW':
                this.dataTemplate(`field${key}`, JSON.stringify(fields))
                propsStr += ` :fields="field${key}" table-name="${tableName || ''}" :form-id="${formId || 0}" :service-id="${serviceId || 0}"`
                break
            case 'FORM_MANAGE':
            case 'FLOW_MANAGE':
                ...
                propsStr += ` view-type="${this.pageType}" :config="config${key}" :form-ids="formIds${key}"  :service-id="${serviceId || 0}"`
                break
            default:
                break
        }
