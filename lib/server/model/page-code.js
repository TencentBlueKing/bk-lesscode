...
class PageCode {
    ...
    generataNocodePage () {
        ...
        const { config = {}, fields = [], formIds = {}, serviceId = 0 } = this.nocodePayload
        ...
        switch (this.nocodeType) {
            ...
            case 'FLOW_MANAGE':
                ...
                propsStr += ` :config="config${key}" :form-ids="formIds${key}"  :service-id="${serviceId || 0}"`
                break
            default:
                break
        }
