...
class PageCode {
    ...
    getItemStyles (compId, renderStyles, props, cssNamePrefix = '') {
        ...
        const itemStyles = ''
        const itemClass = `${!hasStyle ? `class='bk-layout-component-${this.uniqueKey}'` : `class='bk-layout-component-${this.uniqueKey} ${className + (props && props.hasOwnProperty('swiper-animate-effect') && ' ani') || ''}'`}`
