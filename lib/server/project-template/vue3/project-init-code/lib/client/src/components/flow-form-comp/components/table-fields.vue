<template>
  <div class="table-fields-wrapper">
      ...
      <bk-table-column
        ...
        <template #default="{ row }">
          <table-cell-value
            ...
            @view-rich-text="handleViewRichText">
          </table-cell-value>
        </template>
      </bk-table-column>
    ...
    <table-cell-detail
      ...
      v-model:id="cellDetailId"
      :fields="colFields">
    </table-cell-detail>
    <bk-sideslider
      title="富文本"
      :width="640"
      v-model:is-show="showRichText"
      :quick-close="true"
      :show-mask="true"
      v-if="richText"
    ...
    <table-view v-model:show="showTableDetail" :value="tableValue" :field="tableField">
    </table-view>
  </div>
</template>
<script>
