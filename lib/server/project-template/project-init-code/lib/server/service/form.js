...
export const grantApiGWPermissionForItsm = async () => {
    ...
    logger.info(`创建${process.env.BKPAAS_ENVIRONMENT}环境完成`)
    ...
    logger.info(`为itsm主动授权完成，appCode为${global.ITSM_APP_CODE}`)
}
