...
const appCodeId = `${process.env.BK_PROJECT_ID}${process.env.BK_PROJECT_CODE}`
const BK_APP_APIGW_PREFIX = `${process.env.BK_API_URL_TMPL.replace('{api_name}', `lesscode-${appCodeId}`.slice(0, 30))}/${process.env.BKPAAS_ENVIRONMENT}`
