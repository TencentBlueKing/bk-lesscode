...
export default {
    ...
    computed: {
        api () {
            return `${this.host}${framework === 'vue2' ? '/component/compapi/tof3/get_all_staff_info/' : '/component/compapi/tof3/get_all_staff_info/?format=jsonp&app_code=workbench'}`
        }
    },
    watch: {
        value: {
    ...
    render (render) {
        ...
        const renderV3 = () => h({
            ...
            props: {
                ...
                maxData: self.fieldData.props.multiple ? -1 : 1, // vue3版本的人员选择器，是否多选配置
                api: self.api,
                placeholder: self.fieldData.configure.placeholder,
                disabled: self.disabled,
                fixedHeight: true,
        ...
        return this.hostLoading ? null : (framework === 'vue2' ? renderV2() : renderV3())
    }
}
