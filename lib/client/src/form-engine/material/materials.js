const materials = [
    ...
    },
    {
        ...
        desc: '',
        props: {},
        properties: ['name', 'key', 'readonly', 'required', 'hidden', 'validate', 'labelTips']
    },
    {
        group: '基础控件',
        type: 'select',
    ...
    },
    {
        ...
        desc: '',
        props: {},
        properties: ['name', 'key', 'tableConfig', 'readonly', 'required', 'hidden', 'validate', 'value', 'valLinkageRules', 'labelTips']
    },
    {
        group: '基础控件',
        type: 'rate',
