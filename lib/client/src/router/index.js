...
const BackendModule = () => import(/* webpackChunkName: 'resources' */'@/views/project/backend-module/index.vue')
...
const previewBackendApi = () => import(/* webpackChunkName: 'inner-preview' */'@/views/preview/preview-backend-api')
...
const routes = [
    ...
    {
        path: '/preview-api/project/:projectId',
        name: 'previewBackendApi',
        component: previewBackendApi,
        meta: {
            navigation: 'empty',
            title: 'Saas Api'
        }
...
router.beforeEach(async (to, from, next) => {
    try {
        ...
        // 路由中的projectId设置到store中
        store.commit('setCurrentProjectId', to.params?.projectId)
        next()
    } catch (e) {
        console.error(e)
    }
