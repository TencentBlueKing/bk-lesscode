...
const AuthManage = () => import(/* webpackChunkName: 'auth-manage' */'@/views/project/auth-manage/index.vue')
const AppPermModel = () => import(/* webpackChunkName: 'app-perm-model' */'@/views/project/app-perm-model/index.vue')
