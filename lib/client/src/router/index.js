...
const PageManage = () => import(/* webpackChunkName: 'page' */'@/views/project/page-manage')
...
const routes = [
    ...
    },
    {
        ...
        components: {
            ...
            iamPermission: require('@/views/status/no-iam-perm-project').default
        },
...
const checkViewAuth = async (to) => {
    ...
    if (hasPermission) {
        ...
        // if (typeof hasPermission === 'object' && !hasPermission.pass) {
        //     Vue.set(topRoute.meta, 'view', 'iamPermission')
        //     Vue.set(topRoute, 'props', { authResult: hasPermission })
        //     console.error(topRoute)
        // } else {
        //     Vue.set(topRoute.meta, 'view', 'default')
        // }
    } else {
