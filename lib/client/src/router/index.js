...
const CredentialManage = () => import(/* webpackChunkName: 'resources' */'@/views/project/credential-manage.vue')
...
const Changelog = () => import(/* webpackChunkName: 'help' */'@/views/changelog/index.md')
...
const FlowList = () => import(/* webpackChunkName: 'flow' */'@/views/project/flow-manage/flow-list.vue')
const FlowArchivedList = () => import(/* webpackChunkName: 'flow' */'@/views/project/flow-manage/archived-list.vue')
const FlowEdit = () => import(/* webpackChunkName: 'flow' */'@/views/project/flow-manage/edit/index.vue')
const FlowConfig = () => import(/* webpackChunkName: 'flow' */'@/views/project/flow-manage/edit/flowConfig.vue')
const FlowAdvancedConfig = () => import(/* webpackChunkName: 'flow' */'@/views/project/flow-manage/edit/advancedConfig.vue')
