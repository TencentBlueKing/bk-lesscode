...
export default {
    ...
    actions: {
        getApiGateWayApiList (_, params) {
            return http.get(`${perfix}/apigateway/apis`, { params }).then((res = {}) => {
                return res.data || []
            })
        },

        getApiGateWayStagList (_, params) {
            return http.get(`${perfix}/apigateway/stages`, { params }).then((res = {}) => {
                return res.data || []
            })
        },

        getApiGateWayNameList () {
            return http.get(`${perfix}/apigateway/api-names`).then((res = {}) => {
                return res.data || []
            })
        },

        getCategoryAndApiList (_, params) {
            return http.get(`${perfix}/category-children-list`, { params }).then((res = {}) => {
                return res.data || []
            })
        },
        ...
        getApiList (_, params) {
            return http.get(`${perfix}/api`, { params }).then((res = {}) => {
                return res.data || []
            })
        },

        createApi (_, api) {
            return http.post(`${perfix}/api`, api).then((res = {}) => {
                return res.data || {}
            })
        },

        deleteApi (_, id) {
            return http.delete(`${perfix}/api`, { params: { id } }).then((res) => {
                return res.data
            })
        },

        editApi (_, api) {
            return http.put(`${perfix}/api`, api, { globalError: false }).then((res) => {
                return res.data || {}
            })
        },

        getApiDetail (_, params) {
            return http.get(`${perfix}/api/detail`, { params }).then((res) => {
                return res.data || {}
            })
        }
    }
