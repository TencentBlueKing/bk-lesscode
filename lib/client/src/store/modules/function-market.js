...
export default {
    ...
    actions: {
        ...
        updateFunction (_, func) {
            return http.put(`${perfix}/updateFunction`, func, { globalError: false }).then((res = {}) => {
                return res.data
            })
        },
        ...
        createFunctionFromMarket (_, postData) {
            return http.post(`${perfix}/createFunctionFromMarket`, postData, { globalError: false }).then((res = {}) => {
                return res.data
            })
        }
    }
