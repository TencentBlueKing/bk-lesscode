...
export default {
    ...
    actions: {
        ...
        getAppDetailInfo ({ state }, appCode) {
            return http.get(`/release/getAppDetail?appCode=${appCode}`).then(response => {
                const data = response.data || {}
                return data
            })
        },
        ...
        /**
         * 获取部署前各阶段详情
         * @param {Object} data 请求参数：appCode, moduleId, env, deployId
        */
       
        deployPhaseResult ({ state }, data) {
            return http.get(`/release/deployPhaseResult?appCode=${data.appCode}&moduleCode=${data.moduleId}&env=${data.env}&deployId=${data.deployId}`).then(response => {
                const data = response.data || false
                return data
            })
        },
        ...
        /**
         * 获取部署阶段日志
         * @param {Object} data 请求参数：appCode, moduleId, env
        */
       
        processListResult ({ state }, data) {
            return http.get(`/release/processListResult?appCode=${data.appCode}&moduleCode=${data.moduleId}&env=${data.env}`).then(response => {
                const data = response.data || false
                return data
            })
        },
        ...
        */
        ...
        processDetailResult ({ state }, data) {
            return http.post('/release/processDetailResult', data).then(response => { // &env=${data.env}
                const data = response.data || false
                return data
            })
        }
