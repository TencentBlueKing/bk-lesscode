...
export default {
    ...
    actions: {
        checkSaasPerm ({ rootGetters }, params) {
            return http.post(`/projects/${rootGetters['project/currentProjectId']}/saas-backend/checkSaasPerm`, params).then(response => {
        ...
        execModuleStory ({ rootGetters }, params) {
            return http.post(`/projects/${rootGetters['project/currentProjectId']}/saas-module-story/execStory`, params).then(response => {
                const data = response.data
                return data
            })
        },
        ...
        getSaasApiDoc ({ _ }, params) {
            return http.get(`/projects/${params.projectId}/saas-module-story/getBuilderApiDoc?appName=${params.appName}`).then(response => {
                const data = response.data
                return data
            })
        }
