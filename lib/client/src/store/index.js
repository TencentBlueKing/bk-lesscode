...
import thirdPartDB from './modules/third-part-db'
...
export const storeConfig = {
    ...
    getters: {
        ...
        showAlertNotice: state => state.showAlertNotice || false,
        bodyHeight: state => state.showAlertNotice ? 'calc(100vh - 92px)' : 'calc(100vh - 52px)'
    },
    // 公共 mutations
    mutations: {
        ...
        updateShowAlertNotice (state, isShow) {
            state.showAlertNotice = isShow
        },

        setCurrentProjectId (state, projectId) {
            state.projectId = projectId
            console.log(state.projectId, 'commit')
        }
    },
    actions: {
        /**
