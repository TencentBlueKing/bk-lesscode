...
function handleReject (error, config) {
    ...
    let message = error.message || window.i18n.t('接口异常_无法访问')
    ...
    if (typeof message === 'string' && message.match(/Network Error/)) message = window.i18n.t('Network Error，网络不可用，有可能是跨域原因引起')
