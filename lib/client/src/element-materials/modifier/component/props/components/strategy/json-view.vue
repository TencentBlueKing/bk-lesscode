    ...
    <section>
        ...
        <bk-dialog
            ...
            <main class="main-container" :style="{ 'height': showInput ? '450px' : '350px' }">
                <div class="init-json">
                    <span class="area-name">编辑区</span>
                    <div class="area-container">
                        <textarea ref="jsonInput" class="json-input" placeholder="请输入JSON格式的数据" v-model="initJsonStr"></textarea>
                    </div>
                </div>
                <div class="transform-json">
                    <span class="area-name">预览区</span>
