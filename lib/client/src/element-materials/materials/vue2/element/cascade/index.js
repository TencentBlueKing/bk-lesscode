...
export default {
    ...
    props: {
        ...
        props: {
            ...
            dataOrigin: 'options',
            keys: [
                { id: 'value', label: 'value', type: 'tag-input', tips: '指定选项的值,不填取 value 字段' },
                { id: 'label', label: 'label', type: 'tag-input', tips: '指定选项标签,不填取 label 字段' },
                { id: 'expandTrigger', label: 'expandTrigger', type: 'input', tips: '次级菜单的展开方式,不填取默认 click 方式' },
                { id: 'multiple', label: 'multiple', type: 'boolean', tips: '是否多选' },
                { id: 'checkStrictly', label: 'checkStrictly', type: 'boolean', tips: '是否严格的遵守父子节点不互相关联' }
            ],
            val: {
                value: 'value',
                label: 'label',
