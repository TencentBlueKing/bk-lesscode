...
export default {
    ...
    props: {
        ...
        extCls: {
            ...
            tips: '配置自定义样式类名，传入的类会被加在组件最外层的DOM.bk-date-picker上'
        },
        extPopoverCls: {
            type: 'string',
            displayName: '下拉框最外层元素的类名',
            tips: '配置自定义样式类名，传入的类会被加在弹出的日历面板DOM.bk-date-picker-dropdown上'
        }
    }
}
