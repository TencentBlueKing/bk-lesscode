...
export default {
    ...
    displayName: '输入框',
    group: '表单',
    document: 'https://vant-contrib.gitee.io/vant/#/zh-CN/fielda',
    events: [
        {
            name: 'focus',
    ...
    slots: {
        label: {
            name: ['text'],
            type: ['text'],
            displayName: '自定义输入框左侧文本',
            val: '自定义输入框左侧文本'
        },
        input: {
            name: ['text'],
            type: ['text'],
            displayName: '自定义输入框，使用此插槽后，与输入框相关的属性和事件将失效',
            val: '自定义输入框，使用此插槽后，与输入框相关的属性和事件将失效'
        },
        'left-icon': {
            name: ['text'],
            type: ['text'],
            displayName: '自定义输入框头部图标',
            val: '自定义输入框头部图标'
        },
        'right-icon': {
            name: ['text'],
            type: ['text'],
            displayName: '自定义输入框尾部图标',
            val: '自定义输入框尾部图标'
        },
        'button': {
            name: ['text'],
            type: ['text'],
            displayName: '自定义输入框尾部按钮',
            val: '自定义输入框尾部按钮'
        },
        'error-message': {
            name: ['text'],
            type: ['text'],
            displayName: '自定义底部错误提示文案',
            val: '自定义底部错误提示文案'
        },
        extra: {
            name: ['text'],
            type: ['text'],
            displayName: '自定义输入框最右侧的额外内容',
            val: '自定义输入框最右侧的额外内容'
        }
    }
}
