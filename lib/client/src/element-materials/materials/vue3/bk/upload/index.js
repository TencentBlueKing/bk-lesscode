...
export default {
    ...
    props: {
        ...
        type: {
            ...
            val: 'formdata',
            displayName: '上传类型',
            tips: '上传类型。formdata为表单形式上传，文件流包裹在表单数据中。binary为纯文件流传输。',
            belongGroup: 'uploadType'
        },
        // validateName: {
        //     type: 'regexp',
        //     displayName: '验证文件名是否合法的',
        //     tips: '用来验证文件名是否合法的'
        // },
        files: {
            type: 'array',
        ...
        selectChange: {
            type: 'function',
            displayName: 'change事件或拖拽事件处理函数',
            tips: 'input元素change事件或拖拽事件处理函数，若返回false则取消文件选择',
            belongGroup: 'other'
        }
    }
}
