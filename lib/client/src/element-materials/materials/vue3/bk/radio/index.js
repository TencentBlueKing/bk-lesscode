...
export default {
    ...
    slots: {
        default: {
            ...
            val: [
                { name: '单选一', label: '', modelValue: '1', checked: false, disabled: false },
                { name: '单选一', label: '', modelValue: '2', checked: false, disabled: false },
                { name: '单选一', label: '', modelValue: '3', checked: false, disabled: false }
            ],
            payload: {}
        }
    }
