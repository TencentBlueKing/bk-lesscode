    ...
    slots: {
        default: {
            ...
            keys: [
                ...
                { id: 'sortable', label: '全局排序', tips: '从数据中获取是否排序的字段key，不填取 sortable 字段' },
                { id: 'filterable', label: '全局过滤', tips: '从数据中获取是否过滤的字段key，不填取 filterable 字段' }
            ],
            val: [
                { label: '第一列', prop: 'prop1', sortable: false, filterable: false, type: '' },
                { label: '第二列', prop: 'prop2', sortable: false, filterable: false, type: '' },
                { label: '第三列', prop: 'prop3', sortable: false, filterable: false, type: '' }
            ]
        }
    }
}
