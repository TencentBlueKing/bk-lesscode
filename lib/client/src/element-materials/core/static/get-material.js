...
export const registerMaterial = (type, config, framework) => {
    if (materialMap[framework][type]) {
        console.error(`registerMaterial: ${framework} 组件 ${type} 已存在`)
        return
    }
