        ...
        detailList: [
            {
                reviseTitle: '新增',
                logMassage: [
                    '平台：统一优化表格无数据时展示、搜索相关场景交互',
                    '平台: 统一优化平台文本溢出展示及交互',
                    '应用: 凭证token改成自动获取, 去掉凭证管理页面',
                    '应用：功能页面增加对应文档指引入口',
                    '流程&表单: 数据管理页支持添加操作按钮',
                    '流程&表单: 新增评分组件',
                    '画布: 移动端拖拽时、自适应单位',
                    '画布: 移动端input增加宽度设置',
                    '画布: 新增文本框基础组件',
                    '画布: 表单容器支持配置操作按钮显示或隐藏'
                ]
            }, {
                reviseTitle: '修复',
                logMassage: [
                    '应用: 函数调试体验问题优化',
                    '流程&表单: 表单字段配置隐藏条件增加校验空表单逻辑',
                    '画布: 修复存为模板时，组件id被替换导致预览模板报错问题'
                ]
            }
        ]
    },
        ...
        detailList: [
            {
                ...
                logMassage: [
                    ...
                    '应用：自定义组件管理支持导出功能',
                    '应用：自定义组件分类支持单独修改',
                    '画布: 增加画布中交互式组件的检测和使用提示',
                    '画布: 表单画布头部操作按钮顺序和自定义画布保持一致',
                    '其它: 版本更新日志交互优化'
                ]
            }, {
                reviseTitle: '修复',
                logMassage: [
                    '应用: 修复没有PC根路径时根路由无法绑定移动端路由的问题及根路由支持解除绑定',
                    '应用: 函数调试体验问题优化',
                    '应用: 修复数据源建表新增字段报错问题'
                ]
            }
