...
export default {
    setup () {
        ...
        const showAlertNotice = computed(() => {
            return store.getters['showAlertNotice']
        })
        const fetchPageList = () => {
    ...
    render (render) {
        ...
        return h({
            ...
            class: [
                ...
                { 'form-page-width': this.pageDetail.nocodeType === 'FORM' },
                { 'has-alert-notice': this.showAlertNotice }
            ],
