    ...
    render (render) {
        ...
        const renderHeaderSlot = () => {
            return h({
                ...
                slot: 'header',
                props: {
                    theme: 'light lesscode-layout-message lesscode-layout-message-theme',
                    arrow: false,
                ...
                children: [
                    h({
                        ...
                        props: {
                            ...
                            openedKeys: self.curTemplateData.menuList.map(menu => menu.pageCode),
                            themeColorProps: self.themeColorProps
                        },
                        children: self.curTemplateData.menuList.map((menuItem) => {
                            return h({
                                component: MenuItem,
                                ref: 'item',
                                refInFor: true,
