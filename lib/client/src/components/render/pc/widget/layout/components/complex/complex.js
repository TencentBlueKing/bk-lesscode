...
export default {
    ...
    render (render) {
        ...
        const currentSideCustomCon = LC.getSideNavCustomConById(this.activeTopMenuId, topMenuData?.sideCustomCon)
        ...
        const renderSideDragArea = () => {
            return h({
                component: ResolveComponent,
                ref: 'component',
                key: currentSideCustomCon?.renderKey,
                class: {
                    'nav-custom-area': true
                },
                props: {
                    componentData: currentSideCustomCon
                }
            })
        }
        ...
        const renderHelpMenu = () => {
            return h({
                component: HelpMenu,
                props: {
                    isWhiteTopTheme: self.isWhiteTopTheme
                }
            })
        }
                        ...
                        children: self.getCurTemplateData().topMenuList?.map?.((topMemu) => {
                            return h({
                                ...
                                class: {
                                    ...
                                    // 'item-active': self.checkMenuActive(topMemu),
                                    'theme-item': !self.isDefaultTopTheme
                                },
                                style: self.getActiveItemStyle(topMemu),
                                on: {
