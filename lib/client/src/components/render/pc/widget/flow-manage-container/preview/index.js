                ...
                children: [
                    h({
                        ...
                        children: [
                            ...
                            renderOperateArea(),
                            (this.currentNodeTab && !this.currentNodeTab.hideFilters && this.currentNodeTab.filters.length > 0) ? renderFilters() : '',
