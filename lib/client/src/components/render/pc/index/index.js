...
export default {
    ...
    created () {
        ...
        LC.addEventListener('active', this.clearActiveElement)
    ...
    beforeDestroy () {
        ...
        LC.removeEventListener('active', this.clearActiveElement)
            ...
            const nodes = [h({
                ...
                props: {
                    ...
                    group: {
                        ...
                        pull: true,
                        put: (target, source) => {
                            console.log('target group name: layout ========>', target.option('group').name)
                            return source.option('group')?.name !== 'bkform-engine-material'
                        }
                    }
                },
