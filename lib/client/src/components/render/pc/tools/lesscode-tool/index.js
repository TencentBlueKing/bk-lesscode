...
import useCheckFormEngine from './hooks/use-check-form-engine'
...
export default {
    ...
    render (render) {
        ...
        const renderHover = () => {
            const hoverCls = [cssModule['tools-hover']]
            if (useCheckFormEngine(self.hoverComponentData.type)) {
                hoverCls.push(cssModule['tools-form-engine-hover'])
            }
            return h({
                component: 'div',
                class: hoverCls,
        ...
        const renderActive = () => {
                ...
                const tools = [
                    {
                        ...
                        tips: self.$t('存为模板'),
                        condition: self.activeComponentData?.type !== 'widget-form-container'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        condition: self.activeComponentData.componentId && !self.activeComponentData.isInteractiveComponent && !self.activeComponentData?.parentNode?.isInteractiveComponent && self.activeComponentData?.type !== 'widget-form-container'
                    },
                    {
            ...
            const activeCls = [cssModule['tools-active']]
            if (useCheckFormEngine(self.activeComponentData.type)) {
                activeCls.push(cssModule['tools-form-engine-active'])
            }
