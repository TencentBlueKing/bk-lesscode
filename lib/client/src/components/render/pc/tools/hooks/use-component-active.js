...
export default function (callbak) {
    ...
    const componentDragStartCallbak = () => {
        console.log('from componentDragStartCallbakcomponentDragStartCallbak')
        callbak()
    }

    const componentDragEndCallbak = () => {
        console.log('from componentDragEndCallbakcomponentDragEndCallbakcomponentDragEndCallbak')
        callbak(componentData.value)
    }
