...
<img src="../../../images/help/canvas-comp.png" alt="grid" width="350px" class="help-img">
...
<img src="../../../images/help/canvas-pagesetting.png" alt="grid" width="80%" class="help-img">
以及可以设置页面的生命周期函数
<img src="../../../images/help/canvas-pagefunc.png" alt="grid" width="80%" class="help-img">
