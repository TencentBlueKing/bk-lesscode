...
#### 1. Select an Application and Enter the Application Management

> In the application list, select the application to edit or create a new application (the newly created application will automatically enter the application management page).
...
<img src="../../../../images/help/en/component-upload.png" alt="grid" width="80%" class="help-img" />
...
<img src="../../../../images/help/en/component-create.png" width="80%" class="help-img" />

## Using Custom Components on Pages

#### Specify the Page to Use the Component

> Select the page to edit from the application page list, or create a new page for editing.
