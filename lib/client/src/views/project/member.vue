    ...
    <section>
        <div class="member-container">
            <div class="member-head">
                <bk-button theme="primary">{{ $t('添加') }}</bk-button>
            </div>
                ...
                <bk-table :data="list" type="small" ext-cls="member-table">
                    ...
                    <bk-table-column :label="$t('操作')" width="150">
                        <template slot-scope="props">
                            ...
                            <bk-button theme="primary" text :disabled="false" @click="deleteView(props.row)">{{ $t('删除') }}</bk-button>
                        </template>
                    </bk-table-column>
                </bk-table>
            </div>
                ...
                list: [
                    {
                        ...
                        'roleId': '1',
                        'createUser': 'admin',
                        'createTime': '2020-07-14 13:14:00'
                    }
                ]
            }
        }
