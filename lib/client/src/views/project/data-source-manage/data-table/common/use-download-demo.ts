    ...
    'columns': [
        {
            ...
            'nullable': false,
            'default': '',
            'comment': window.i18n.t('自增唯一主键。系统保留字段，不可修改'),
            'createDate': false,
            'updateDate': false,
            'length': 11,
            'columnId': 'id',
        ...
        },
        {
            ...
            'nullable': true,
            'default': '',
            'comment': window.i18n.t('系统会默认写入数据创建时间。系统保留字段，不可修改'),
            'createDate': true,
            'updateDate': false,
            'length': 0,
            'columnId': 'createTime',
        ...
        },
        {
            ...
            'nullable': true,
            'default': '',
            'comment': window.i18n.t('系统会默认写入数据创建人。系统保留字段，不可修改'),
            'createDate': false,
            'updateDate': false,
            'length': 255,
            'columnId': 'createUser',
        ...
        },
        {
            ...
            'nullable': true,
            'default': '',
            'comment': window.i18n.t('系统会默认写入数据更新时间。系统保留字段，不可修改'),
            'createDate': false,
            'updateDate': true,
            'length': 0,
            'columnId': 'updateTime',
        ...
        },
        {
            ...
            'nullable': true,
            'default': '',
            'comment': window.i18n.t('系统会默认写入数据更新人。系统保留字段，不可修改'),
            'createDate': false,
            'updateDate': false,
            'length': 255,
            'columnId': 'updateUser',
