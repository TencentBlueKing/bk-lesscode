        ...
        <div class="package-container" v-bkloading="{ isLoading: isLoading, opacity: 1 }">
            <div class="package-content">
                <bk-table :data="list" type="small" ext-cls="package-table" empty-text="暂无部署版本包">
                    <bk-table-column :label="$t('版本号')" prop="version" show-overflow-tooltip></bk-table-column>
                    <bk-table-column :label="$t('创建时间')" prop="createTime" :formatter="timeFormatter" show-overflow-tooltip>
                    </bk-table-column>
                    <bk-table-column :label="$t('创建人')" prop="createUser" show-overflow-tooltip></bk-table-column>
