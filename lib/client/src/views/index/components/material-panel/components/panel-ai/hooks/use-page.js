...
export default (cmdMessage) => {
    const handleGetHomePageTemplate = () => {
        cmdMessage.value += [
            '',
            '# cmd',
            'you can use `component.all()` to get completed component list first',
            'and then You can refer to the following commands to generate a homePage:',
            // 设置页面边距
    ...
    const handleGetDataSearchPageTemplate = () => {
        cmdMessage.value += [
            ...
            '# cmd',
            'you can use `component.all()` to get completed component list first',
            'and then You can refer to the following commands to generate a dataSearchPage:',
    ...
    const handleGetDataAnalysisPageTemplate = () => {
        ...
        cmdMessage.value += [
            ...
            '# cmd',
            'you can use `component.all()` to get completed component list first',
            'and then You can refer to the following commands to generate a dataAnalysisPage:',
            // 数据分布图
